    ...
    <div class="container">
        <div class="card shadow h-100">
            <div class="card-header">
                <h5 class="m-0 pt-1 font-weight-bold float-left">Sanksi Create </h5>
                <a href="{{ route('tmsanksi.index') }}" class="btn btn-sm btn-secondary float-right ">Kembali</a>

            </div>
            <div class="card-body">
                <form action=" {{ route('tmsanksi.store') }} " method="post" enctype="multipart/form-data">
                    @method('post')
                    @csrf
