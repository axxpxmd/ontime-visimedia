        ...
        <div class="col-md-6">
            <div class="card shadow h-100">
                <div class="card-header">
                    ...
                    <a href="{{ route('atasanActivities.index') }}" class="btn btn-sm btn-secondary float-right ">Kembali</a>
                </div>
                <div class="card-body">
                    <form action=" {{ route('atasanActivities.store') }} " method="post" enctype="multipart/form-data">
                        @csrf
