        ...
        <div class="col-md-6">
            <div class="card shadow h-100">
                <div class="card-header">
                    ...
                    <a href="{{ route('atasanActivities.index',$activities) }}" class="btn btn-sm btn-secondary float-right">Kembali</a>
                </div>
                <div class="card-body">
                    <form action=" {{ route('atasanActivities.update', $activities->id) }} " method="post" enctype="multipart/form-data">
                        @method('patch')
                        @csrf
                        ...
                        <div class="text-center mb-3">
                            <img id="image" src="{{ Storage::url($activities->foto) }}" alt="{{ $activities->foto }}" class="img-thumbnail mb-1">
                        </div>
