        ...
        <div class="col-md-6">
            <div class="card shadow h-100">
                <div class="card-header">
                    <h5 class="m-0 pt-1 font-weight-bold float-left">Lihat Aktifitas</h5>
                    <a href="{{ route('activities.index',$activitie) }}" class="btn btn-sm btn-secondary float-right">Kembali</a>
                </div>
                <div class="card-body">
                    <form action=" " method="post" id="target" enctype="multipart/form-data">
                        @method('patch')
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control @error('keterangan') is-invalid @enderror" id="keterangan" name="keterangan" disabled>{{ $activitie->keterangan }}</textarea>
